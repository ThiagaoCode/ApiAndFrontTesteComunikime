package Api.Teste.Comunikime.configuration;
...
.basePackage("Api.Teste.Comunikime.controller"))
...
.title("API - Loja Comunikime")
.description("Projeto API Spring - Loja Comunikime")
.version("1.0.0")
